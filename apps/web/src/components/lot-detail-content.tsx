...
function LotDetailContentInner({ lotId }: LotDetailContentProps) {
...
export function LotDetailContent({ lotId }: LotDetailContentProps) {
  return (
    <Authenticated>
      <LotDetailContentInner lotId={lotId} />
    </Authenticated>
  );
}
